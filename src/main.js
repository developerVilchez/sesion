...
const viewPaloma = () => {
  ...
  <section id="psico-1">
    ...
    <div class="row">
      <div class="col s12">
        <h2 class="section-title">Perfil psicoterapeuta</h2>
      </div>
    </div>
          ...
          <div class="icon-profile">
            <div class="row icon-profile-wrapper">
              ...
              <div class="col s12 l8">
                ...
                <p class="light">Lic. En Psicología Clínica de la Pontificia Universidad Católica del Perú y Mg. En Estudios Teóricos en Psicoanálisis de la PUCP. </p>
                </div>
            </div>
          </div>
          <div class="info-profile container">
            <div class="row">
              <div class="col s10 offset-s1 m12">
                ...
                <!-- Modal Trigger -->
                <a class="waves-effect waves-light button-primary modal-trigger" href="#modal1" id="contacto-paloma">Contactar</a>
              </div>
            </div>
     ...
     <div class="col s12">
       ...
       <div class="icon-profile">
         ...
         <div id="modal1" class="modal">
           ...
           <div class="modal-footer">
             <a href="#!" class="modal-close waves-effect waves-green btn-flat button-secondary" id="contacta-santiago-wasap">Inicia Sesión</a>
           </div>
         </div>  
       </div>
     </div>
